<template>
  <div>
    ...
    <pagination :pages="pagination" @changepage="getImgStorage"></pagination>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    delImg () {
      const vm = this
      const url = `${process.env.VUE_APP_APIPATH}/api/${process.env.VUE_APP_UUID}/admin/storage/${vm.copyPrdouct.id}`
